        ...
        <div className="bid-detail-div">
          <div className="row">
            <div className="col-md-12">
              <Image src={imgUrl} width="220" height="160" rounded />
            </div>
          </div>
          <div className="row">
            <div className="col-md-12 ">
              <div>
                <div className="livestock-info">
                  ...
                  <h5>Rent Amount - ₹{this.props.basePrice}</h5>
                  ...
                  <div>
                    ...
                    <form className="form-inline bid-form" onSubmit={this.handleSubmit}> 
                      {this.props.timeFromServer >0 &&
                        ...
                        <input type="submit" className="btn btn-primary bid-submit-btn" value="Rent" />
                      </div>
                       }
                    </form>
                    ):(
                      <input type="button" className="btn btn-primary rebid-input" value="Rent it" onClick={this.reBid.bind(this)}/>
                    )
                   }
          ...
          <div className = "row bid-history-div">
            {Object.keys(this.props.bidHistory).length > 0 &&
              <div>
                <h4 className="bid-history-header ">Rent History</h4>
